...
<uni-list>
	<uni-list-item title="自定义右侧插槽" note="列表描述信息" link>
		<template slot="header">
			<image class="slot-image" src="https://img.jx885.com/lrjk_uniapp/img/logo.png" mode="widthFix"></image>
		</template>
	</uni-list-item>
	<uni-list-item>
		<!-- 自定义 header -->
		<view slot="header" class="slot-box"><image class="slot-image" src="https://img.jx885.com/lrjk_uniapp/img/logo.png" mode="widthFix"></image></view>
		<!-- 自定义 body -->
