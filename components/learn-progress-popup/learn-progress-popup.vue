	...
	<uni-popup ref="popup" type="bottom" @maskClick="closeAction" @change="onChange">
		<view class="warp" :style="{'margin-bottom': `${safeBottom}px`}">
			<view class="bottom_bar">
				...
				<view class="bottom_right_error_layout">
				...
				<view class="bottom_mic_layout" @click="showSkillAction">
				...
				<view class="bottom_icon_label" @click="closeAction">
					...
					<label>{{current + 1}}/{{ruleListSize }}</label>
				</view>
			...
			<view class="clear_record_warp" @click="clearRecord">
				<text>清空做题记录</text>
				<image :src="$util.ossImagePath('/learn/icon_del_clear.png')"></image>
			</view>
